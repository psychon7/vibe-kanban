  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'cp-secondary': "hsl(var(--cp-secondary))",
        'cp-accent': "hsl(var(--cp-accent))",
        'cp-success': "hsl(var(--cp-success))",
        'cp-error': "hsl(var(--cp-error))",
        'cp-warning': "hsl(var(--cp-warning))",
        'cp-info': "hsl(var(--cp-info))",
        'cp-background': "hsl(var(--cp-background))",
        'cp-foreground': "hsl(var(--cp-foreground))",
        'cp-surface': "hsl(var(--cp-surface))",
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { boxShadow: 'var(--cp-glow-primary)' },
          '50%': { boxShadow: '0 0 30px rgba(0, 217, 255, 0.7), 0 0 60px rgba(0, 217, 255, 0.5)' },
        },
        'neon-flicker': {
          '0%, 100%': { opacity: '1' },
          '50%': { opacity: '0.8' },
      ...
      boxShadow: {
        'glow-primary': 'var(--cp-glow-primary)',
        'glow-secondary': 'var(--cp-glow-secondary)',
        'glow-accent': 'var(--cp-glow-accent)',
        'glow-success': 'var(--cp-glow-success)',
        'glow-error': 'var(--cp-glow-error)',
      },
    },
  },
